...
[cmdletbinding()]
param(
	[string] $ConnectionString = "Data Source=localhost,1433;Initial Catalog=AlwaysEncryptedSample;UID=sa;PWD=alwaysB3Encrypt1ng;Application Name=Encryption.ps1;",
	...
	[string] $DacLocation = 'C:\Program Files (x86)\Microsoft SQL Server\140\DAC\bin\',
