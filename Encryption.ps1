...
[cmdletbinding()]
param(
	[string] $ConnectionString = "Server=localhost,11433;User Id=sa;Password=a1waysB3Encrypting;Application Name=Encryption.ps1;Initial Catalog=AlwaysEncryptedSample",
...
#TODO: Make this a list for production
$encryptionChanges = @()
